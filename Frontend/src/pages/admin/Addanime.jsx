...
export default function AddAnime() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Data anime baru:", formData);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Isi form di bawah untuk menambahkan anime</p>
        </div>
          ...
          <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="Contoh: Demon Slayer"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                required
                rows="4"
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors duration-300 resize-none"
                placeholder="Deskripsi singkat tentang anime..."
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                required
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors duration-300"
                placeholder="Contoh: Action, Adventure, Fantasy (pisahkan dengan koma)"
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                required
                className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors duration-300"
                placeholder="/thumbnail/cover/nama-anime.jpg"
              />
              <p className="text-xs text-gray-500 mt-2">
                Upload gambar ke folder public/thumbnail/cover/ terlebih dahulu
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="rilis"
                  value={formData.rilis}
                  onChange={handleChange}
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors duration-300"
                  placeholder="Contoh: Jan 5, 2025"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 transition-colors duration-300"
                  placeholder="Contoh: Winter 2025"
                />
              </div>
