    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/10 shadow-2xl animate-slide-up">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/10 bg-white/5 text-cyan-400 focus:ring-cyan-400 focus:ring-offset-0 cursor-pointer"
                />
            ...
            <button
              ...
              className={`w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition-all duration-300 ${
                loading
                  ...
                  : "hover:from-cyan-600 hover:to-blue-600 hover:shadow-lg hover:shadow-cyan-500/50 transform hover:scale-105"
              }`}
            >
              {loading ? (
                <>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gradient-to-r from-transparent via-gray-800/80 to-transparent text-gray-400">
                atau
              </span>
            </div>
          </div>
        ...
        <p className="text-center text-gray-500 text-sm mt-8">
          © 2025 Kitsuvibe. All rights reserved.
        </p>
        ...
        <div className="mt-6 bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4 text-center">
          ...
          <div className="space-y-1">
            <p className="text-yellow-300/80 text-xs">Admin - Username: <span className="font-semibold">admin</span> | Password: <span className="font-semibold">admin123</span></p>
            <p className="text-yellow-300/80 text-xs">User - Username: <span className="font-semibold">user1</span> | Password: <span className="font-semibold">user123</span></p>
          </div>
        </div>
      </div>
